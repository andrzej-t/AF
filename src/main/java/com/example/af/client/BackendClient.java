package com.example.af.client;

import com.example.af.configuration.ConnectionConfig;
import com.example.af.domain.Activity;
import com.example.af.domain.Bored;
import com.example.af.domain.StatisticsDto;
import com.example.af.domain.Weather;
